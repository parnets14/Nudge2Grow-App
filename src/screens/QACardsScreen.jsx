/**
 * Q&A Cards Screen - Swipeable Q&A viewer with glassmorphism design
 */
...
const QACard = ({ item, index, total, onSwipeComplete, onSwipeBack, isNext, triggerSwipeRef }) => {
      ...
      >
        <View style={[styles.glassCard, styles.glassCardBehind]}>
          ...
          <View style={styles.cardBody}>
            ...
            <Text style={[styles.qaQuestion, { opacity: 0.4 }]}>
              {item.question}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.cardBody}>
          ...
          {showAnswer ? (
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.8}
            >
              <Icon name="eye-outline" size={18} color="#6B7280" style={{ marginRight: 8 }} />
...
const QACardsScreen = ({
  ...
  }, [currentIndex, qaCards.length, completionScale, completionOpacity]);
  ...
  const nextCard = qaCards[currentIndex + 1];
    ...
    <View style={styles.screen}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerMid}>
          ...
          <Text style={styles.headerSubject} numberOfLines={1}>{subject} · Q&A</Text>
        </View>
        ...
        <View style={styles.progressBarBackground}>
          <View 
            style={[
              ...
              { width: `${((currentIndex + 1) / qaCards.length) * 100}%` }
            ]} 
          />
        </View>
        <Text style={styles.progressCounter}>
          {currentIndex + 1} / {qaCards.length}
        </Text>
      </View>
          ...
          >
            <View style={styles.completionCard}>
              ...
              <Text style={styles.completionMessage}>
                You've completed all Q&A cards for <Text style={styles.completionTopicName}>{topic}</Text>.
              </Text>
        ...
        <View style={styles.navRow}>
          ...
          >
            <Text style={styles.nextBtnText}>
              {currentIndex === qaCards.length - 1 ? 'Done' : 'Next'}
            </Text>
