/**
 * Prompt Cards Screen - Swipeable prompts viewer with glassmorphism design
 */
...
const PromptCard = ({ item, index, total, onSwipeComplete, onSwipeBack, isNext, triggerSwipeRef }) => {
      ...
      >
        <View style={[styles.glassCard, styles.glassCardBehind]}>
          ...
          <View style={styles.cardBody}>
            <Text style={[styles.promptText, { opacity: 0.4 }]}>{item.prompt}</Text>
          </View>
        </View>
      </Animated.View>
    );
      ...
      <View style={styles.glassCard}>
        ...
        >
          ...
          <View style={styles.hintBox}>
            <Text style={styles.hintTitle}>HINT FOR PARENTS</Text>
            <Text style={styles.hintText}>
              {item.hint || 'Encourage your child to think creatively and share their ideas openly.'}
            </Text>
          </View>
        </ScrollView>
      </View>
...
const PromptCardsScreen = ({
  ...
  }, [currentIndex, prompts.length, completionScale, completionOpacity]);
  ...
  const currentCard = prompts[currentIndex];
  const nextCard = prompts[currentIndex + 1];
    ...
    <View style={styles.screen}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerMid}>
          ...
          <Text style={styles.headerSubject} numberOfLines={1}>{subject} · Prompts</Text>
        </View>
          ...
          >
            <View style={styles.completionCard}>
              ...
              <Text style={styles.completionMessage}>
                You've completed all Prompts cards for <Text style={styles.completionTopicName}>{topic}</Text>.
              </Text>
...
export default PromptCardsScreen;
